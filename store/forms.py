...
class ChangePasswordForm(SetPasswordForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields[
            'new_password1'].help_text = ('<ul class="form-text text-muted small"><li>Your password can\'t be too similar '
        ...
        self.fields[
            'new_password2'].help_text = ('<span class="form-text text-muted"><small>Enter the same password as before, '
